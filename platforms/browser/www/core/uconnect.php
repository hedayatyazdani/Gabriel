	...
	public function login()
	{
		...
		if($this->region)
		{
		    if(UniversalConnection::$appkey)
		        header("location: ".$this->region."?apsi=".rawurlencode(UniversalConnection::$appkey)."&auth=".UniversalConnection::$authType."&forwardUrl=".rawurlencode($this->systemUrl));
		    else
		        header("location: ".$this->region."?auth=".UniversalConnection::$authType."&forwardUrl=".rawurlencode($this->systemUrl));
		    die();
		}
	}
